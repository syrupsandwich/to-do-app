...
function moveSelectedTaskObjectsToBottom() {
  ...
  let endOfTaskObjectArray = _main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.tasks.length - 1;
  ...
  selectedElementsInOrder.forEach((element) => {
    ...
    _main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.moveTask(origin, {
...
function reorderTaskObjects() {
  selectedElements.forEach(() => {
    ...
    _main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.moveTask(_main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.tasks.length - 1, {
