...
/***/ "./src/program/initiation-setup.js":
/*!*****************************************!*\
  !*** ./src/program/initiation-setup.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initiateSetup": () => (/* binding */ initiateSetup)
/* harmony export */ });
/* harmony import */ var _to_do_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./to-do.js */ "./src/program/to-do.js");
...
const initiateSetup = () => {
  if (sessionStorage.categoryTimestampsObject) {
    ...
    initiationObject.categoryTimestamps.forEach((timestamp) => {
      ...
      (0,_to_do_js__WEBPACK_IMPORTED_MODULE_0__.makeCategory)(categoryDataImport);
      ...
      categoryDataImport.projectTimestamps.forEach((timestamp) => {
        ...
        let category = _to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories[_to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories.length - 1];
...
const loadDemo = () => {
  ...
  (0,_to_do_js__WEBPACK_IMPORTED_MODULE_0__.makeCategory)({
    title: "Welcome",
    timestamp: categoryCount++,
  });

  let welcome = _to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories[_to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories.length - 1];
  ...
  let fitness = _to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories[_to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories.length - 1];
  ...
  let finance = _to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories[_to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories.length - 1];
  ...
  let otherInterests = _to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories[_to_do_js__WEBPACK_IMPORTED_MODULE_0__.categories.length - 1];
...
/* harmony import */ var _initiation_setup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./initiation-setup.js */ "./src/program/initiation-setup.js");
/* harmony import */ var _task_events_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./task-events.js */ "./src/program/task-events.js");
/* harmony import */ var _task_element_generator_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./task-element-generator.js */ "./src/program/task-element-generator.js");
/* harmony import */ var _set_task_template_text__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./set-task-template-text */ "./src/program/set-task-template-text.js");
...
(0,_initiation_setup_js__WEBPACK_IMPORTED_MODULE_2__.initiateSetup)();
(0,_set_task_template_text__WEBPACK_IMPORTED_MODULE_5__.setTemplateTitle)();
(0,_set_task_template_text__WEBPACK_IMPORTED_MODULE_5__.setTemplateNoteTexts)();
...
let currentProject = _to_do_js__WEBPACK_IMPORTED_MODULE_1__.categories[0].projects[0];
(0,_task_element_generator_js__WEBPACK_IMPORTED_MODULE_4__.appendTaskElements)(projectTaskContainer, currentProject);
...
/***/ "./src/program/session-storage-updater.js":
/*!************************************************!*\
  !*** ./src/program/session-storage-updater.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "updateSessionStorageObject": () => (/* binding */ updateSessionStorageObject)
/* harmony export */ });
...
/***/ "./src/program/set-task-template-text.js":
/*!***********************************************!*\
  !*** ./src/program/set-task-template-text.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setTemplateNoteTexts": () => (/* binding */ setTemplateNoteTexts),
/* harmony export */   "setTemplateTitle": () => (/* binding */ setTemplateTitle)
/* harmony export */ });
...
/***/ "./src/program/task-element-generator.js":
/*!***********************************************!*\
  !*** ./src/program/task-element-generator.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "appendTaskElements": () => (/* binding */ appendTaskElements),
/* harmony export */   "cloneTemplateLiElement": () => (/* binding */ cloneTemplateLiElement),
/* harmony export */   "getDateLabelText": () => (/* binding */ getDateLabelText),
/* harmony export */   "makeTaskElement": () => (/* binding */ makeTaskElement)
/* harmony export */ });
...
function getDateLabelText(date) {
  if (date === "none" || !date) {
    ...
    return `Due on ${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date), "EEEE, MMM d")}`;
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _to_do_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./to-do.js */ "./src/program/to-do.js");
/* harmony import */ var _task_element_generator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./task-element-generator.js */ "./src/program/task-element-generator.js");
/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./main.js */ "./src/program/main.js");
...
function writeToTask() {
  let task = (0,_to_do_js__WEBPACK_IMPORTED_MODULE_0__.findTask)(taskTimestampId);
...
noteOptionsContainer.addEventListener("click", (e) => {
  ...
  if (e.target.dataset.name === "add-note-btn") {
    ...
    let liClone = (0,_task_element_generator_js__WEBPACK_IMPORTED_MODULE_1__.cloneTemplateLiElement)({
  ...
  function makeAlternateLiElement(type) {
    let clone = (0,_task_element_generator_js__WEBPACK_IMPORTED_MODULE_1__.cloneTemplateLiElement)({
...
projectTaskContainer.addEventListener("click", (e) => {
  ...
  setTimeout(() => {
    ...
    function updateNoteCheckStatus(liElement) {
      ...
      let task = (0,_to_do_js__WEBPACK_IMPORTED_MODULE_0__.findTask)(timestamp);
...
function updateTaskDate() {
  ...
  let task = (0,_to_do_js__WEBPACK_IMPORTED_MODULE_0__.findTask)(dateInputElement.dataset.dateSettingId);
  ...
  if (!dateInputElement.value) {
    ...
    dateInputElement.labels[0].textContent = (0,_task_element_generator_js__WEBPACK_IMPORTED_MODULE_1__.getDateLabelText)();
    return;
...
function updateTaskTime() {
  ...
  let task = (0,_to_do_js__WEBPACK_IMPORTED_MODULE_0__.findTask)(timeInputElement.dataset.timeSettingId);
...
taskOptionsContainer.addEventListener("click", (e) => {
  if (e.target.id === "remove-task-btn") {
    selectedElements.forEach((element) => {
      let timestamp = element.dataset.timestamp;
      let task = (0,_to_do_js__WEBPACK_IMPORTED_MODULE_0__.findTask)(timestamp);
      let taskIndex = _main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.tasks.indexOf(task);
      _main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.removeTask(taskIndex);
      element.remove();
    });
...
makeTaskBtn.addEventListener("click", () => {
  _main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.makeTask({
    title: "Task title",
  });
  let taskIndex = _main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.tasks.length - 1;
  let task = _main_js__WEBPACK_IMPORTED_MODULE_2__.currentProject.tasks[taskIndex];
  let taskElement = (0,_task_element_generator_js__WEBPACK_IMPORTED_MODULE_1__.makeTaskElement)(task);
...
/* harmony export */   "getTasksForToday": () => (/* binding */ getTasksForToday),
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/formatDistanceToNowStrict/index.js");
...
/* harmony import */ var _session_storage_updater_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./session-storage-updater.js */ "./src/program/session-storage-updater.js");
...
const categoryFactory = ({
  ...
  const setTitle = (input) => {
    ...
    title = input;
    (0,_session_storage_updater_js__WEBPACK_IMPORTED_MODULE_0__.updateSessionStorageObject)(exportOwnData());
  };
  ...
  const taskFactory = ({
    ...
    const getDeadline = () => {
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dueDate), {
    ...
    const setDueDate = (input) => {
      if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(input)) && input !== "none") {
    ...
    const getTimeLeft = () => {
      ...
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dueDate))) {
        return `${(0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(getDeadline())} ago.`;
      }
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(getDeadline());
    };
    ...
    const isDueToday = () => {
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(getDeadline());
    };
    ...
    const extendDeadline = () => {
      ...
      let nextDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(currentDayAndTime, timeExtension);
      dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(nextDueDate, "yyyy-MM-dd");
      let dateWithPreviousTime = getDeadline();
      let nextDeadline = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dateWithPreviousTime, timeExtension);
      dueTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(nextDeadline, "HH:mm:ss");
      timesRepeated++;
      return;
    };
  ...
  const projectFactory = ({
    ...
    const makeTask = (task = {}) => {
      ...
      (0,_session_storage_updater_js__WEBPACK_IMPORTED_MODULE_0__.updateSessionStorageObject)(newTask.exportOwnData());
      (0,_session_storage_updater_js__WEBPACK_IMPORTED_MODULE_0__.updateSessionStorageObject)(exportOwnData());
  ...
  const makeProject = (project = {}) => {
    ...
    (0,_session_storage_updater_js__WEBPACK_IMPORTED_MODULE_0__.updateSessionStorageObject)(newProject.exportOwnData());
    (0,_session_storage_updater_js__WEBPACK_IMPORTED_MODULE_0__.updateSessionStorageObject)(exportOwnData());
...
const makeCategory = (category = {}) => {
  ...
  (0,_session_storage_updater_js__WEBPACK_IMPORTED_MODULE_0__.updateSessionStorageObject)(newCategory.exportOwnData());

  categoryTimestamps.push(newCategory.getTimestamp());
  (0,_session_storage_updater_js__WEBPACK_IMPORTED_MODULE_0__.updateSessionStorageObject)({ categoryTimestamps });
