...
const categoryFactory = (category) => {
  ...
  const taskFactory = ({
    ...
    const setDueDate = (date) => {
      if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date))) {
    ...
    const getTimeLeft = () => {
      if (!dueDate) {
        console.error("The variable dueDate is undefined.");
      }
      if (dueDate === "") {
        console.error("The variable dueDate has not been specified.");
      }
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate));
    };
